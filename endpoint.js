((require, process, module) => {
    ...
    logInfo('Configured Watson (Personality Insights) endpoint: username [' + username + '], password [' + maskedPassword + ']');
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////
    // Watson (Personality Insights) functionality
    ///////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    const parseHttpUrl = (request) => {
        ...
        let path = request && request.path ? request.path : 'v2/profile';
        path = path.startsWith("/") ? path : '/'+path;
        return 'https://'+username+':'+password+'@gateway.watsonplatform.net/personality-insights/api'+path;
    };
    ...
    const httpPost = (req, cb) => {
        ...
        let isCsv = req && req.headers && req.headers['Accept'] == 'text/csv';
    ...
    const genericHttpFunctions = {
        get: genericHttpPost,    // Sends a GET request
